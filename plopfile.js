module.exports = function(plop) {
  ...
  plop.setGenerator("component", {
    ...
    actions: [
      {
        type: "add",
        path: "components/{{properCase name }}/{{properCase name }}.jsx",
        templateFile: "plop-templates/component.hbs"
      },
      {
        type: "add",
        path: "components/{{properCase name }}/{{properCase name }}.css"
      },
      {
        type: "add",
        path: "components/{{properCase name }}/{{properCase name }}.story.js",
